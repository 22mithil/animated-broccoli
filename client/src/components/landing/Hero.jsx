      ...
      <div className="relative z-10 container mx-auto max-w-6xl px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <motion.div
            ...
            animate="visible"
          >
            <h1 className="mx-4 mb-6 text-4xl font-bold tracking-tight sm:text-6xl md:mb-8 md:text-8xl text-center">
              ...
              <span
                className={cn(
                  'from-primary via-primary/90 bg-gradient-to-r to-primary bg-clip-text text-transparent',
          ...
          <motion.div
            ...
            animate="visible"
          >
            <p className="text-muted-foreground mx-auto mb-10  px-4 text-base leading-relaxed sm:text-lg md:text-xl">
              <span>Find movies through rich, story-driven queries.</span>{' '}
              <span>
                Ask for "movies where the hero wears green pants and is betrayed
                by their best friend."
              </span>{' '}
              <span> and discover connections you never knew existed.</span>
            </p>
          </motion.div>
