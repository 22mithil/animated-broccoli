...
class KnowledgeGraphTester:
    ...
    # -------------------
    # 2. CONNECTIVITY TEST (Optimized with APOC)
    # -------------------
...
def main():
    ...
    try:
        ...
        tester.semantic_search("a scene where a boy was murdered in the woods", label="Scene", top_k=5)
        # tester.semantic_search("main protagonist in a magical world", label="Character", top_k=5)
        # tester.semantic_search("a place where a character had won something", label="Location", top_k=5)
        # tester.semantic_search("magical adventure", label="Movie", top_k=3)
